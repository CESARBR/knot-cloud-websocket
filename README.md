...
### activateGateway(uuu): &lt;Void&gt;

Activate a gateway on the cloud. When successful emits a `activated` message.
...
async function main() {
  client.on('ready', () => {
    client.activateGateway('78159106-41ca-4022-95e8-2511695c0000');
  });
  client.on('activated', () => {
    client.close();
  });
